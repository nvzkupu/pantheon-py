...
class Agent:
    ...
    def reset(self) -> None:
        self._history = [Message(role="system", content=self.skill.body)]
    ...
    def send_stream(self, msg: str, on_chunk: Callable[[str], None] | None = None) -> str:
        self._history.append(Message(role="user", content=msg))
    ...
    def run(self, msg: str) -> str:
        ...
        raise RuntimeError(
            f"agent '{self.name}' hit max iterations ({self.skill.max_iterations})")
