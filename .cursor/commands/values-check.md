Apply the @maat skill. Weigh the current decision or approach against NVIDIA engineering values.

Evaluate against all four pillars:

1. **Speed of Light Development** — Does this accelerate or slow the development loop? Build times? Feedback loops? Time-to-value?
